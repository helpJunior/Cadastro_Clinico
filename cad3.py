...
######################### TELA DE CONSULTAS ################################################
    def pesquisar_bd(self):
        ...
        self.Entry_Nome_Pesquisa.configure(background="white", foreground="#000000", font="TkFixedFont")
...
####################### VOLTAR ###################################
    ...
    def alterar_dados(self):
        DataCadastro.cursor.execute(f""" UPDATE Cadastros SET Nome_Completo = ? 
                WHERE  Nome_Completo = ? """, (self.Entry_Nome_Pesquisa))
